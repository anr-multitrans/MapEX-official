...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        dir_interval=1,
        query_embed_type='noisy1_gt_hybrid_pts',
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='/data/maasai/user/resun/nuScenes/perturbed/nuscenes_map_infos_temporal_train.pkl',
	num_perturb=5,
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='/data/maasai/user/resun/nuScenes/perturbed/nuscenes_map_infos_temporal_val.pkl',
        map_ann_file='/data/maasai/user/resun/nuScenes/perturbed/nuscenes_map_anns_val.json',
	num_perturb=5,
