...
point_cloud_range = [-30.0, -60.0,-10.0, 30.0, 60.0, 10.0]
voxel_size = [0.15, 0.15, 20.0]
dbound=[1.0, 35.0, 0.5]

grid_config = {
    'x': [-60.0, -60.0, 0.15], # useless
    'y': [-30.0, -30.0, 0.15], # useless
    'z': [-10, 10, 20],        # useless
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        dir_interval=1,
        query_embed_type='noisy5_gt_hybrid_pts',
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='/data/maasai/user/resun/nuScenes/doublerange/nuscenes_map_infos_temporal_train.pkl',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='/data/maasai/user/resun/nuScenes/doublerange/nuscenes_map_infos_temporal_val.pkl',
        map_ann_file='/data/maasai/user/resun/nuScenes/doublerange/nuscenes_map_anns_val.json',
