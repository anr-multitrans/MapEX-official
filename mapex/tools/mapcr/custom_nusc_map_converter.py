...
def _fill_trainval_infos(nusc,
    ...
    for sample in mmcv.track_iter_progress(nusc.sample):
        ...
        info = obtain_perturb_vectormap(
            #nusc_maps, map_explorer, info, point_cloud_range, sequential = counter in [])
            nusc_maps, map_explorer, info, point_cloud_range, sequential = counter in [13261,13262, 30593, 30592, 30954])
...
parser.add_argument(
    '--out-dir',
    type=str,
    default='/data/maasai/user/resun/nuScenes/mapmodex',
    required=False,
